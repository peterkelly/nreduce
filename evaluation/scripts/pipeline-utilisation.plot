...
plot \
 "< grep total jobs/pipeline-utilisation/pipeline-utilisation.r0.n50/showload.log" \
 using 2:3 title "50 items" with lines ls 1, \
 "< grep total jobs/pipeline-utilisation/pipeline-utilisation.r0.n40/showload.log" \
 using 2:3 title "40 items" with lines ls 2, \
 "< grep total jobs/pipeline-utilisation/pipeline-utilisation.r0.n30/showload.log" \
 using 2:3 title "30 items" with lines ls 3, \
 "< grep total jobs/pipeline-utilisation/pipeline-utilisation.r0.n20/showload.log" \
 using 2:3 title "20 items" with lines ls 4, \
 "< grep total jobs/pipeline-utilisation/pipeline-utilisation.r0.n10/showload.log" \
