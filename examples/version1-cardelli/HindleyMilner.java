public class HindleyMilner
{
  ...
  public static void UnifyType(TypeExp typeExp1, TypeExp typeExp2)
  {
  ...
  public static void UnifyArgs(TypeList list1, TypeList list2)
  {
  ...
  public static void AnalyzeRecDeclBind(Decl decl, Env env[], NonGenericVars list[])
  {
    ...
    case DEF:
      newTypeVar = NewTypeVar();
      decl.dbgvartype = newTypeVar; // dbg
      env[0] = envExtend(decl.binder,newTypeVar,env[0]);
      list[0] = ExtendNGV(newTypeVar,list[0]);
      break;
    case SEQ:
  ...
  public static void AnalyzeRecDecl(Decl decl, Env env, NonGenericVars list)
  {
    switch (decl.type) {
    case DEF:
      UnifyType(envRetrieve(decl.binder,env,list),
